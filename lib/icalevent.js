...
iCalEvent.prototype = {
	...
	toFile: function(){
		...
		if (this.event.allDay) 		result += 'X-MICROSOFT-CDO-ALLDAYEVENT:' + this.event.allDay.toString().toUpperCase() + '\n';
		if (this.event.allDay) 		result += 'X-MICROSOFT-MSNCALENDAR-ALLDAYEVENT:' + this.event.allDay.toString().toUpperCase() + '\n';
